...
import { SpotifyApp } from '../../../../shared/spotify/SpotifyApp.psc'
...
// /spotify-psc plays real, varied music. (See vite/public/media/CREDITS.md.)
let musicIdx = 0
...
export default function SpotifyPsc() {
  return (
    <div className="shell">
      <p>
